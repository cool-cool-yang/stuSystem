...
<head>
    ...
    <script type="text/javascript">
        function checkOldPwdEq(){
            var oldPwd = "${(User.user).getStuPwd()}";
            //alert("原来的老密码："+oldPwd);
...
<div id="container">
    <div id="main">
        ...
        <form action="<c:url value='/student/ModifyTeaInfo.action'/>" name="form" method="post" onsubmit="return sumbit()">
            <input type="hidden" name="stuId" value="${(User.user). getStuId()}">
            <span id="warn1" style="color:red;font-weight:bold;display:none;">➤</span>
            联系方式：  <input type="text" name="stuMobile" id="lxfs" class="input01" value="${(User.user).getStuMobile()}"><span style="color:red">11位数字</span><br/><br/>
            <span id="warn2" style="color:red;font-weight:bold;display:none;">➤</span>
            电子邮箱：  <input type="text" name="stuEmail" id="email" class="input01" value="${(User.user).getStuEmail()}"><span style="color:red">xx+@xx.+xx</span><br/><br/>
            ...
            新的密码：   <input type="password" name="stuPwd" id="pwd2" class="input01">
