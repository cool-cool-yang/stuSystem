...
<%@ page import="com.stuSystem.manager.pojo.other.UserFactory" %>
...
<div id="container">
    <div id="header">
        <div id="headerLeft" style="float:left;">
            ...
            <a href="<c:url value='/user/goPersonPage.action'/>" class="one" style="float:left;">个人服务</a>
        </div>
        <div id="headerRight" style="float:right;">
            ...
            <a href="<c:url value='/user/userExit.action'/>"  style="float:right;display: none" class="logOrExt" id="extId">[退出]</a>
        </div>
    </div>
</div>
</body>