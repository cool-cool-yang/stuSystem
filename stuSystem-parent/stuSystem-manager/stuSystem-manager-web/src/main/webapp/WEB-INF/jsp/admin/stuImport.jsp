...
<div id="container">
    <div id="left">
        ...
        <form action="<c:url value='/student/insertOneStu.action'/>" name="form1" method="post" onsubmit="return sumbit1()">
            ...
            学生姓名：  <input type="text" name="username" id="username" class="input01" ${importStu.username}><span style="color:red">2～20位</span><br/><br/>
            <span id="warn3" style="color:red;font-weight:bold;display:none;">➤</span>
            学生班号：  <input type="text" name="userClass" id="bjh" class="input01" ${importStu.userClass}><span style="color:red">8位数字</span><br/><br/>
            ...
            联系方式：  <input type="text" name="userMobile" id="lxfs" class="input01" ${importStu.userMobile}><span style="color:red">11位数字</span><br/><br/>
            <span id="warn6" style="color:red;font-weight:bold;display:none;">➤</span>
            电子邮箱：  <input type="text" name="userEmail" id="email" class="input01" ${importStu.userEmail}><span style="color:red">xx+@xx.+xx</span><br/><br/>
           ...
           <%-- onfocus="WdatePicker({startDate:'yyyy/MM/dd',dateFmt:'yyyy/MM/dd',isShowWeek:true})"--%>
            出生日期：  <input type="text" name="userBirthday" id="sr" class="input02" readonly="readonly" ${importStu.userBirthday}>
            <span style="color:red">xxxx/xx/xx</span><br/><br/>
            <span id="warn8" style="color:red;font-weight:bold;display:none;">➤</span>
            入学时间：  <input type="text" name="userEnSch" id="rxsj" class="input02" ${importStu.userEnSch}><span style="color:red">xxxx/xx/xx</span><br/><br/>
            <div style="text-align:center;">
    ...
    <div id="right">
        <div style="text-align:center;">
            ...
            <form action="<c:url value='#'/>" name="form2" method="post" onsubmit="return sumbit2()">
                <input type="file" name="excel" id="excel" accept=".xls,.xlsx"><br/>
                <div style="text-align:center;">
                    <input type="submit" class="import"  value="提交"><br/>
                </div>
            </form>
